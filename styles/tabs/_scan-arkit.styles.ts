...
export const styles = StyleSheet.create({
  ...
  partialTrackingComponentPill: {
    borderRadius: 8,
    borderWidth: 1,
    paddingHorizontal: 5,
    paddingVertical: 1,
  },
  partialTrackingComponentPillAvailable: {
    backgroundColor: 'rgba(76, 175, 80, 0.12)',
    borderColor: 'rgba(76, 175, 80, 0.5)',
  },
  partialTrackingComponentPillMissing: {

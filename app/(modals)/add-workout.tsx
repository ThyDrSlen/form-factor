      ...
      {Platform.OS !== 'ios' && exerciseModalVisible ? (
        <View style={styles.overlay}>
          ...
          <SafeAreaView style={styles.modalContainer}>
            ...
            <TouchableOpacity
              style={[
                styles.modalCustomButton,
                exerciseSearch.trim().length === 0 && styles.modalCustomButtonDisabled,
              ]}
              onPress={() => {
            ...
            >
              <Text style={styles.modalCustomButtonText}>
                {exerciseSearch.trim().length
                  ? `Use "${exerciseSearch.trim()}"`
                  : 'Type a name to add custom exercise'}
              </Text>
            </TouchableOpacity>
          </SafeAreaView>
        </View>
